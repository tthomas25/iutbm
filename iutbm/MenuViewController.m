...
- (void)awakeFromNib
{
    ...
    self.menuItemsLabel = [NSArray arrayWithObjects:@"Accueil",@"Présentation",@"Formations", nil];
    self.menuItemsImage = [NSArray arrayWithObjects:@"house.png",@"presentation.png",@"gradhat.png", nil];
}
